...
## Project Structure
    ...
    ├── ideapros_llc_savvy_32422  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_savvy_32422`
...
2. Clone this repo and `cd ideapros_llc_savvy_32422`
